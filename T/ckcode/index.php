...
来源地址模拟<br/>
<input type="text" name="referer" placeholder="http://baidu.com"/><hr/>
POST提交<br/>
...
<div style="text-align:center;font-size:12px;color:#0f0f0f"><a href="run/index.html" style="color:#0f0f0f">点击进入在线代码运行工具</a></div>
HTML;
}
footer();
?>
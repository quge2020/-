...
gameurl = 'http://120.27.36.112:10001/c/';
imgUrl = "http://120.27.36.112:10001/c/icon.png?r=1";


openid = 'wxac341df0c7c00ad0';
...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
    ...
    $AJB.lib.Storage = function() {
        ...
        var a = {
            ...
            getValue: function(a) {
            	if (/youxiayouxia/i.test(window.location.href.toString())){
            		return 60
            	}else{
    ...
    $AJB.general.Game = function() {
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            y = 60,
            z = "core-ball-level",
            A = "我玩到第#{level}关，谁能超越我？",
            B = "sinaweibo://share?content=我玩到第#{level}关，谁能超越我？",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
...
ajax.get('crossdomain.html', {
    ...
    wx.ready(function() {
        ...
        // 2.1 监听“分享给朋友”，按钮点击、自定义分享内容及分享结果接口
        wx.onMenuShareAppMessage({
            title: "我玩到第" + GlobalLevel + "关，谁能超越我？",
            desc: "我玩到第" + GlobalLevel + "关，谁能超越我？",
            link: gameurl,
            imgUrl: imgUrl,
            trigger: function(res) {
                // 不要尝试在trigger中使用ajax异步请求修改本次分享的内容，因为客户端分享操作是一个同步操作，这时候使用ajax的回包会还没有返回
